...
<div class="navbar">
   ...
   <select name="rposition" class="rposition" id="span22">
	...
	<div class="control-group">
    <label class="control-label" for="input01">Election Name:</label>
    <div class="controls">
	...
	<div class="control-group">
    <label class="control-label" for="input01">Election Date:</label>
    <div class="controls">
	<input type="date" name="ryear" id="span2" class="ryear" required>
    </div>
    </div>
